Config = {
    ...
    Messages = {
        NoClipTriggered = "[Extreme AC]노클립 사용을 감지하여 벤이되셨습니다. 벤에 관하여 문의하실려면 DISCORD",
        ChatMessageTriggered = "[Extreme AC]채팅메세지 트리거 감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        BlacklistedEventTriggered = "[Extreme AC]금지된 트리거 사용감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        BlacklistedEntity = "[Extreme AC]금지된 엔디티 사용감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD.",
        UnauthorizedResources = "[Extreme AC]승인되지 않은 리소스 감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        ProhibitedVariables = "[Extreme AC]금지된 변수감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        CommandsTriggered = "[Extreme AC]금지된 커멘트 사용으로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        ESXTriggered = "[Extreme AC]ESX트리거 사용감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        SpectateTriggered = "[Extreme AC]사용자 관전감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
        BlacklistedWeaponTriggered = "[Extreme AC]금지된 무기 사용감지로 인해 벤이되셨습니다. 벤에 관하여 문의하시려면 DISCORD",
    },
    KickForKeys = false, 
    BlacklistedKeys = { 
